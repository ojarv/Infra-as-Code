...
Vagrant.configure("2") do |win11|
	...
	win11.vm.provision "shell",
		inline: 'Set-Location -Path "C:/Users/vagrant"; Invoke-WebRequest -Uri "https://repo.saltproject.io/windows/Salt-Minion-Latest-Py3-x86-Setup.exe" -OutFile "setup.exe"; Start-Process -Wait -FilePath ".\setup.exe" -ArgumentList "/S"; Remove-Item -Path "setup.exe" -Force',
		run: "once"
	win11.vm.provision "shell",
